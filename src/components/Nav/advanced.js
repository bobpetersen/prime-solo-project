...
function expandUniformShorthandValues(
    prop,
    unit,
    ...values
) {
...
export const padding = expandUniformShorthandValues.bind(
    null,
    "padding",
    "px"
);

export const margin = expandUniformShorthandValues.bind(
    null,
    "margin",
    "px"
);
...
const utils = ["padding", "margin"].reduce(
    (a, n) => (
        (a[n] = expandUniformShorthandValues.bind(
            null,
            n,
            "px"
        )),
